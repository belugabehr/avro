...
public class GenericWithDefaultTest {
  ...
  public void encode(final TestStateEncode state) throws Exception {
    ...
    final GenericDatumWriter<Object> writer =
        new GenericDatumWriter<>(state.schema);
  ...
  public void decode(final Blackhole blackhole, final TestStateDecode state)
    ...
    final GenericDatumReader<Object> reader =
        new GenericDatumReader<>(state.schema);
  ...
  public static class TestStateDecode extends BasicState {
    ...
    public void doSetupTrial() throws IOException {
      ...
      final GenericDatumWriter<Object> writer =
          new GenericDatumWriter<>(this.schema);
