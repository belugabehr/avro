...
public class IntTest {
  ...
  public static class TestStateEncode extends BasicState {
    ...
    /**
     * Avro uses Zig-Zag variable length encoding for numeric values. Ensure
     * there are some numeric of each possible size.
     *
  ...
  public static class TestStateDecode extends BasicState {
    ...
    /**
     * Avro uses Zig-Zag variable length encoding for numeric values. Ensure
     * there are some numeric values of each possible size.
     *
     * @throws IOException Could not setup test data
     */
    @Setup(Level.Trial)
